        ...
        <div class="jobsearch-post-settings" style="min-height: 500px;">
            <div class="pckges-typeinfo-con">
                ...
                <ul>
                    ...
                    <li><strong><?php esc_html_e('Jobs Package with featured credits', 'wp-jobsearch') ?>:</strong> <?php esc_html_e('This package is for employers to post jobs with featured credits.', 'wp-jobsearch') ?></li>
                    <li><strong><?php esc_html_e('Employer download CV\'s Package', 'wp-jobsearch') ?>:</strong> <?php esc_html_e('This package is for employers to save a specific number of resumes.', 'wp-jobsearch') ?></li>
                    <li><strong><?php esc_html_e('All in one Package', 'wp-jobsearch') ?>:</strong> <?php esc_html_e('This package is for employers to post jobs, featured jobs and download CVs.', 'wp-jobsearch') ?></li>
                    <li><strong><?php esc_html_e('Single Featured Job credit', 'wp-jobsearch') ?>:</strong> <?php esc_html_e('This package is for employers to post single featured job only.', 'wp-jobsearch') ?></li>
                    <li><strong><?php esc_html_e('Candidate Job Apply Package', 'wp-jobsearch') ?>:</strong> <?php esc_html_e('This package is for candidates to apply a specific number of jobs.', 'wp-jobsearch') ?></li>
            ...
            <div id="featured_jobs_package_fields" class="job-package-fields specific-pkges-fields" style="display: <?php echo ($package_type == 'featured_jobs' ? 'block' : 'none') ?>;">
                ...
                <div class="jobsearch-element-field">
                    ...
                    ?>
                    <div class="elem-field">
                        <div id="limted-pkgexp-con-<?php echo ($unl_pkg_rand) ?>" class="limited-expiry-pkkgcon <?php echo ($unlimtd_pkg_fcredexpval == 'on' ? 'limted-disabled' : '') ?>" style="float: left; width: 70%;">
                            <div class="input-select-field input-f">
                                <?php
                                $field_params = array(
                        ...
                        <div style="float: right; width: 27%;">
                            <div class="unlimitd-chekbox">
                                <input type="checkbox" id="unli-pkgexp-<?php echo ($unl_pkg_rand) ?>" data-id="<?php echo ($unl_pkg_rand) ?>" <?php echo ($unlimtd_pkg_fcredexpval == 'on' ? 'checked' : '') ?>>
                                <label for="unli-pkgexp-<?php echo ($unl_pkg_rand) ?>"><?php esc_html_e('Never', 'wp-jobsearch') ?></label>
                                <input type="hidden" id="unli_pkgexp_<?php echo ($unl_pkg_rand) ?>" name="jobsearch_field_unlimited_fcredexp" value="<?php echo ($unlimtd_pkg_fcredexpval) ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="elem-field">
                        ...
                        <div style="float: right; width: 27%;">
                            <div class="unlimitd-chekbox">
                                <input type="checkbox" id="unli-pkgexp-<?php echo ($unl_pkg_rand) ?>" data-id="<?php echo ($unl_pkg_rand) ?>" <?php echo ($unlimtd_pkg_fcredexpval == 'on' ? 'checked' : '') ?>>
                                <label for="unli-pkgexp-<?php echo ($unl_pkg_rand) ?>"><?php esc_html_e('Never', 'wp-jobsearch') ?></label>
                                <input type="hidden" id="unli_pkgexp_<?php echo ($unl_pkg_rand) ?>" name="jobsearch_field_unlimited_fall_credexp" value="<?php echo ($unlimtd_pkg_fcredexpval) ?>">
                            </div>
                        </div>
                    </div>
                </div>
