            ...
            <?php if ($all_locations_type != 'api') { ?>
                ...
                <div class="jobsearch-element-field">
                    ...
                    if ($loc_optionstype == '2' || $loc_optionstype == '3') {
                        ?>
                        <input type="hidden" name="jobsearch_field_location_location1" id="countryId" data-randid="<?php echo($rand_num) ?>"
            ...
            <script>
                ...
                jQuery(document).ready(function () {
                    ...
                    var geocoder<?php echo($rand_num) ?> = new MapboxGeocoder({
                        ...
                        placeholder: '<?php echo esc_js($loc_address) ?>',
                        marker: false,
                        mapboxgl: mapboxgl
                    });
                ...
                <ul class="jobsearch-row jobsearch-employer-profile-form">
                    ...
                    if ($all_locations_type != 'api') {
                        ...
                        <li class="jobsearch-column-6" data-randid="<?php echo($rand_num) ?>">
                            ...
                            <?php
                            if ($loc_optionstype == '2' || $loc_optionstype == '3') { ?>
                                <input type="hidden" data-randid="<?php echo($rand_num) ?>" name="jobsearch_field_location_location1"
                                       id="countryId"
                                       value="<?php echo($contry_singl_contry) ?>"/>
                                <?php
                            }
