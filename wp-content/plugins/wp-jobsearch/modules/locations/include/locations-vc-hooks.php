    ...
    class jobsearch_allocations_vc_hooks
    {
        ...
        public function apiloc_dropdowns_field($settings, $value)
        {
            ...
            <div class="jobsearch-vcloc-dropdwn-con">
                ...
                $myArray = json_decode($total_countries);
                ...
                $single_country_code = $myNewArray[$arrayKey[0]]->code;
                ...
                <select id="stateId">
                    ...
                    if ($states_cntry != '') {
                        foreach ($api_states_list['result'] as $api_state_key => $api_state_val) { ?>
                            <option value="<?php echo($api_state_val) ?>" <?php echo($api_state_val == $saved_state ? 'selected="selected"' : '') ?>
                                    data-stateid=<?php echo($api_state_key) ?>><?php echo($api_state_val) ?></option>
                            <?php
                        }
                    }
                    ?>
