...
//
        ...
        public static function quick_job_application_popup_form($job_id)
        {
            ...
            <?php } else {
                $arg = array(
                    'classes' => 'widget_application_apply_form',
                ...
                echo apply_filters('jobsearch_job_applications_forms', '', $arg);
            }
        ...
        public function jobsearch_job_applications_forms_callback($html, $arg = array())
        {
            global $jobsearch_plugin_options;
        ...
        public static function job_application_quick_apply_form_without_login($job_id)
        {
            global $jobsearch_plugin_options;
            $phone_validation_type = isset($jobsearch_plugin_options['intltell_phone_validation']) ? $jobsearch_plugin_options['intltell_phone_validation'] : '';
