...
// hook things up
            ...
            if (is_array($custom_all_fields_saved_data) && sizeof($custom_all_fields_saved_data) > 0 && !empty($selected_fields)) {
                ...
                foreach ($custom_all_fields_saved_data as $f_key => $custom_field_saved_data) {
                    ...
                    if (isset($custom_field_saved_data['type']) && $custom_field_saved_data['type'] == "heading" && ($field_name != '' && in_array($field_name, $selected_fields))) {
                        ...
                        $output .= apply_filters('jobsearch_form_custom_field_video_load', '', $post_id, $custom_field_saved_data, $fields_prefix, $con_class, $f_display);
                        ...
                        $output .= apply_filters('jobsearch_form_custom_field_linkurl_load', '', $post_id, $custom_field_saved_data, $fields_prefix, $con_class, $f_display);
                        ...
                        $output .= apply_filters('jobsearch_form_custom_field_upload_file_load', '', $post_id, $custom_field_saved_data, $fields_prefix, $con_class, $f_display);
                        ...
                        $output .= apply_filters('jobsearch_form_custom_field_checkbox_load', '', $post_id, $custom_field_saved_data, $fields_prefix, $con_class, $f_display);
    ...
    static function jobsearch_form_custom_field_checkbox_load_callback($html, $post_id, $custom_field_saved_data, $fields_prefix, $con_class = '', $f_display = '', $self_vals = array())
    {
                                    ...
                                    foreach ($cus_field_value_arr as $key => $single_value) {
                                        if ($single_value != '') {
                                            if (isset($cus_format) && $cus_format != '') {
                                                ...
                                                echo '<small>';
                                                echo esc_html(ucwords(str_replace("-", " ", $single_value)));
                                                echo '</small>';
                                            }
                                        }
                                    }
