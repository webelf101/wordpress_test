                ...
                if ($employer_loc_filter_view == 'dropdowns' && $all_locations_type != 'api') {
                    ...
                    <div class="jobsearch-checkbox-toggle"
                        ...
                        if ($all_locations_type == 'api') {
                            ...
                            <ul class="jobsearch-row jobsearch-employer-profile-form">
                                ...
                                <li class="jobsearch-column-12">
                                    ...
                                    <div id="jobsearch-gdapilocs-statecon" data-val="<?php echo($loc_location2) ?>"
                                         class="jobsearch-profile-select">
                                        <select name="location_location2" <?php echo('class="states' . ($states_class) . '" id="stateId"') ?>>
                                                ...
                                                if ($states_cntry != '') {
                                                    ...
                                                    if ($selected_contry_key != '') {
                                                        ...
                                                        foreach ($api_states_list as $api_state_key => $api_state_val) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo($api_state_val) ?>" <?php echo($api_state_val == $loc_location2 ? 'selected="selected"' : '') ?>
                                                                    stateid=<?php echo($api_state_key) ?>><?php echo($api_state_val) ?></option>
                                                            <?php
                                                        }
                                                    }
                                                }
                                ...
                                if ($loc_optionstype == '1' || $loc_optionstype == '2') {
                                    ...
                                    <li class="jobsearch-column-12">
                                        ...
                                        <div id="jobsearch-gdapilocs-citycon" data-val="<?php echo($loc_location3) ?>"
                                             class="jobsearch-profile-select">
                                            <select name="location_location3" <?php echo('class="cities' . ($cities_class) . '" id="cityId"') ?>>
                                                <option value=""><?php esc_html_e('Select City', 'wp-jobsearch') ?></option>
                                                <?php
                                                if ($is_ajax) {
                                                    if (isset($api_states_list) && !empty($api_states_list) && $loc_location2 != '') {
                                                        $selected_state_key = array_search($loc_location2, $api_states_list);
                                                        ...
                                                        foreach ($api_cities_list as $api_city_key => $api_city_val) {
                                                            ?>
                                                            <option value="<?php echo($api_city_val) ?>" <?php echo($api_city_val == $loc_location3 ? 'selected="selected"' : '') ?>
                                                                    cityid="<?php echo($api_city_key) ?>"><?php echo($api_city_val) ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    //
                            ...
                            if ($loc_counter > 6) {
                                echo '<a href="javascript:void(0);" class="show-toggle-filter-list jobsearch-loadmore-locations" data-ptype="employer" data-pnum="2" data-tpgs="' . $total_pages . '" data-rid="' . $global_rand_id . '" data-cousw="' . $left_filter_count_switch . '">' . esc_html__('+ see more', 'wp-jobsearch') . ' <small class="loc-filter-loder"></small></a>';
                            }
                        }  ?>
