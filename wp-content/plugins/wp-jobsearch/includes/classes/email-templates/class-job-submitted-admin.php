...
if (!class_exists('jobsearch_job_submitted_admin_template')) {
    ...
    class jobsearch_job_submitted_admin_template {
        ...
        public function jobsearch_job_submitted_admin_template_init() {
            ...
            $this->switch_label = esc_html__('New Job submitted to admin', 'wp-jobsearch');
        ...
        public function jobsearch_job_submitted_admin_callback($user = '', $job_id = '') {
            ...
            if (isset($template['switch']) && $template['switch'] == 1) {
                ...
                if ($job_emp_id > 0 && get_post_type($job_emp_id) == 'employer') {
                    $employer_user_id = jobsearch_get_employer_user_id($job_emp_id);
                    $user_obj = get_user_by('ID', $employer_user_id);
                    
                    $args['from_name'] = get_the_title($job_emp_id);
                    $args['from_email'] = isset($user_obj->user_email) ? $user_obj->user_email : '';
                }
        ...
        public function template_settings_callback($email_template_options) {
            ...
            $email_template_options['job_submitted_admin']['email_template_group'] = $this->email_template_group;
