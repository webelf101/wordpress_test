                            ...
                            <div class="careerfy-jobs-wrapper-style9">
                                <div class="careerfy-jobs-box1">
                                    ...
                                    <small class="careerfy-jobs-style9-options">
                                        <?php if ($jobsearch_job_min_salary != '' && $jobsearch_job_max_salary != '') { ?>
                                            <i class="fa fa-money"></i><?php echo esc_html__('Salary', 'wp-jobsearch') ?><?php echo $jobsearch_job_min_salary . "K" ?>-<?php echo $jobsearch_job_max_salary . "K " . $salary_type ?>
                                        <?php } ?>
                                    </small>
                                ...
                                <div class="careerfy-jobs-box2">
                                    ...
                                    $book_mark_args = array(
                                        ...
                                        'before_label' => esc_html__('Save this job', 'careerfy'),
                                        'container_class' => '',
            ...
            if ($view == 'view2') {
                ...
                <div class="jobsearch_side_box jobsearch_box_view_jobs">
                    ...
                    <a href="<?php echo esc_url(get_permalink($job_posted_by)); ?>"
                       title="<?php echo esc_html(get_the_title($job_id)); ?>"
                       class="jobsearch_box_view_jobs_btn"><?php echo esc_html__('View all jobs', 'wp-jobsearch') ?> <i
...
add_action('wp_footer', 'jobsearch_job_postin_canedmsgs_init', 11);

function jobsearch_job_postin_canedmsgs_init($_view_script = false)
{
    ...
    if (!$to_view_script && $_view_script === false) {
        return false;
    }
    ...
    <script type="text/javascript">
        ...
        foreach ($temps_posts as $temps_postid) {
            ...
            $the_desc = apply_filters('the_content', $cont_desc);
...
if (!function_exists('jobsearch_job_send_message_employer_callback')) {
    ...
    function jobsearch_job_send_message_employer_callback()
    {
        ...
        echo json_encode(array('html' => esc_html__('Your Message has been sent, will contact you shortly', 'wp-jobsearch'), 'error' => '0'));
        wp_die();
    }
...
function jobsearch_job_det_applybtn_acthtml($html, $job_id, $use_in = 'filter', $job_view = 'view1')
{
    ...
    if ($job_view == 'view5') {
        ...
        if ($application_deadline != '' && $application_deadline <= $current_date) { ?>
            ...
            $arg = array(
                'classes' => 'widget_application_apply_btn jobsearch-applyjob-btn-style5',
        ...
        if ($application_deadline != '' && $application_deadline <= $current_date) {
            ...
            $arg = array(
                'classes' => 'jobsearch_box_jobdetail_three_apply_link',
        ...
        if ($application_deadline != '' && $application_deadline <= $current_date) { ?>
            ...
            $arg = array(
                'classes' => 'widget_application_apply_btn jobsearch-applyjob-btn',
                'btn_before_label' => esc_html__('Apply for this job', 'wp-jobsearch'),
                'btn_after_label' => esc_html__('Successfully Applied', 'wp-jobsearch'),
                'btn_applied_label' => esc_html__('Applied', 'wp-jobsearch'),
                'job_id' => $job_id
