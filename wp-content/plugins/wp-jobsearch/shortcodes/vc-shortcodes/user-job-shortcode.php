...
{
    global $jobsearch_plugin_options, $job_userreg_withmail, $job_form_errs, $package_form_errs, $jobsearch_currencies_list, $sitepress, $wpdb, $jobsearch_gdapi_allocation;
                    ...
                    if ($pkgs_query->have_posts()) {
                        ...
                        while ($pkgs_query->have_posts()) : $pkgs_query->the_post();
                            ...
                            <tr>
                                ...
                                if ($pkg_type == 'emp_allin_one' || $pkg_type == 'featured_jobs') {
                                    ?>
                                    <td>
                                ...
                                <table class="buynew-plans-list">
                                    ...
                                    foreach ($pkgs_qposts as $pkg_id) {
                                        ...
                                        <tr id="buy-newpkgitem-<?php echo absint($pkg_rand) ?>"<?php echo($is_pckg_subscribed ? ' class="pkg-disabled"' : '') ?>>
                                            ...
                                            <?php
                                            if ($pkg_otype == 'emp_allin_one' || $pkg_otype == 'featured_jobs') {
                                                ?>
                                                <td>
                                                    <?php printf(esc_html__('Normal Jobs: %s','wp-jobsearch'), $total_jobs) ?>
                                                    <br>
                        ...
                        <ul class="jobsearch-row jobsearch-employer-profile-form">
                            ...
                            if ($job_types_switch == 'on') {
                                ...
                                echo apply_filters('jobsearch_jobpostin_jobtype_select_html', $type_whole_html, $job_id);
                            }
                            // for urgent job
