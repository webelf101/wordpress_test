            ...
            <form class="jobsearch-banner-search" method="get" action="<?php echo(get_permalink($result_page)); ?>">
                <ul>
                    ...
                    if ($keyword_field == 'show') {
                        ?>
                        <li>
                            <input placeholder="<?php echo apply_filters('jobsearch_own_sh_adv_srch_keywords_str', esc_html__('Job Title, Keywords, or Phrase', 'wp-jobsearch')) ?>"
                                   name="search_title" type="text">
                        </li>
                        <?php
                    }
                    ...
                    if ($loc_field == 'show') {
                        if ($all_locations_type != 'api') {
                            ...
                            if ($loc_locate_1 != '') {
                                ?>
                                <li>
                                    <input type="hidden" name="location_location1"
                                           value="<?php echo($loc_location1) ?>">
                    ...
                    if ($serch_btn_txt != '') {
                        ?>
                        <li class="jobsearch-banner-submit with-btn-txt dynamic-class-<?php echo($rand_num) ?>"><input
                                    type="submit" value="<?php echo($serch_btn_txt) ?>"<?php echo($srch_btn_style) ?>>
                        </li>
                        <?php
                    } else {
                        ?>
