                                ...
                                <ul class="jobsearch-jobdetail-options">
                                    ...
                                    if ((!empty($employer_address) || ($locations_lat != '' && $locations_lng != '')) && $all_location_allow == 'on') {
                                        ...
                                        <li>
                                            ...
                                            ?>
                                            <a href="<?php echo ($google_mapurl) ?>" target="_blank" class="jobsearch-jobdetail-view"><?php esc_html_e('View on Map', 'wp-jobsearch') ?></a>
                                        </li>
                                        <?php
                                    }
                    ...
                    <aside class="jobsearch-column-4 jobsearch-typo-wrap">
                        ...
                        if ($emp_det_contact_form != 'off') {
                            ...
                            <div class="jobsearch_side_box jobsearch_box_contact_form">
                                ...
                                ?>
                                <div class="jobsearch-wdg-box-title"><h2><?php esc_html_e('Contact Form', 'wp-jobsearch') ?></h2></div>
