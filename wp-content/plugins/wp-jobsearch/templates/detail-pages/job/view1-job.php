                                        ...
                                        <ul class="jobsearch-jobdetail-options">
                                            ...
                                            if ($jobsearch_job_posted_formated != '' && $job_views_publish_date == 'on') {
                                                ...
                                                <li>
                                                    ...
                                                    : <?php echo esc_html($jobsearch_job_posted_formated); ?></li>
                                                <?php
                                            }
                        ...
                        <div class="jobsearch-column-8 jobsearch-typo-wrap">
                            ...
                            <div class="jobsearch-jobdetail-content">
                                ...
                                if ($job_content != '') {
                                    ...
                                    ?>
                                    <div class="jobsearch-content-title">
                                        <h2><?php echo esc_html__('Job Description', 'wp-jobsearch') ?></h2></div>
                                ...
                                if ($skills_list != '') {
                                    ...
                                    ?>
                                    <div class="jobsearch-content-title">
                                        <h2><?php echo esc_html__('Required skills', 'wp-jobsearch') ?></h2></div>
