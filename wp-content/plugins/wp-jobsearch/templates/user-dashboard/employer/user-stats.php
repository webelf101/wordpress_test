                ...
                <div class="jobsearch-dashprofpkgs-con">
                    ...
                    if (!empty($cpropkgs_posts)) {
                        ...
                        <div class="all-chprofpkg-list">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="profpkg-hding"><span><?php esc_html_e('Plan Name', 'wp-jobsearch') ?></span></th>
                                        <th class="profpkg-titlemid"><span><?php esc_html_e('Price', 'wp-jobsearch') ?></span></th>
                                        <th class="profpkg-btnsec"><span><?php esc_html_e('Actions', 'wp-jobsearch') ?></span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    foreach ($cpropkgs_posts as $cpropkgs_pkgid) {
                                        ...
                                        add_action('wp_footer', function () use ($popup_args) {
                                            ...
                                            //
                                            ?>
                                            <div class="jobsearch-modal profpckg-popup-main fade" id="JobSearchModalProfPckg<?php echo ($p_pkgid) ?>">
                                                ...
                                                <div class="modal-content-area">
                                                    <div class="modal-box-area">
                                                        ...
                                                        <div class="profpckg-detail-pcon">
                                                            ...
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Profile Fields:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($show_profile_fields) ?></div>
                                                            </div>
                                                            <?php
                                                            if (isset($show_custf_fields)) {
                                                                ?>
                                                                <div class="profpkg-det-item">
                                                                    <div class="detitem-label"><?php esc_html_e('Custom Fields:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($show_custf_fields) ?></div>
                                                                </div>
                                                                <?php
                                                            }
                                                            ?>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Social Fields:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($show_social_fields) ?></div>
                                                            </div>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Statistics:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($ppkg_pbase_stats == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                                            </div>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Location:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($ppkg_pbase_location == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                                            </div>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Account Members:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($ppkg_pbase_accmembs == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                                            </div>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Employer Team:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($ppkg_pbase_team == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                                            </div>
                                                            <div class="profpkg-det-item">
                                                                <div class="detitem-label"><?php esc_html_e('Company Photos/Videos:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo ($ppkg_pbase_gphotos == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                                            </div>
                                                            <div class="profpkg-item-subscon">
                                                                <a href="javascript:void(0);" class="jobsearch-subsemp-profile-pkg" data-id="<?php echo($p_pkgid) ?>"><?php esc_html_e('Buy Now', 'wp-jobsearch') ?> <span class="pkg-loding-msg" style="display:none;"></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="profpkg-hding"><span><?php echo get_the_title($cpropkgs_pkgid) ?></span></td>
                                            <td class="profpkg-titlemid"><span><?php echo ($profp_plan_price) ?></span></td>
                                            <td class="profpkg-btnsec">
                                                <div class="profpkg-btn-holdr">
                                                    <a href="javascript:void(0);" class="modelprofpkg-pop-btn modelprofpkg-btn-<?php echo ($cpropkgs_pkgid) ?>" data-id="<?php echo ($cpropkgs_pkgid) ?>"><?php esc_html_e('View Detail', 'wp-jobsearch') ?></a>
                                                    <a href="javascript:void(0);" class="jobsearch-subsemp-profile-pkg buy-profpkgbtn" data-id="<?php echo($cpropkgs_pkgid) ?>"><?php esc_html_e('Buy Now', 'wp-jobsearch') ?> <span class="pkg-loding-msg" style="display:none;"></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
                    ...
                    if ($user_has_profpkg) {
                        ...
                        add_action('wp_footer', function () use ($popup_args) {
                            ...
                            //
                            ?>
                            <div class="jobsearch-modal profpckg-popup-main fade" id="JobSearchModalProfPckg<?php echo ($p_rand) ?>">
                                <div class="modal-inner-area">&nbsp;</div>
                                <div class="modal-content-area">
                                    <div class="modal-box-area">
                                        <div class="jobsearch-modal-title-box">
                                        ...
                                        <div class="profpckg-detail-pcon">
                                            ...
                                            <div class="profpkg-det-item">
                                                <div class="detitem-label"><?php esc_html_e('Statistics:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo (isset($p_order_detail['pbase_stats']) && $p_order_detail['pbase_stats'] == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                            </div>
                                            <div class="profpkg-det-item">
                                                <div class="detitem-label"><?php esc_html_e('Location:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo (isset($p_order_detail['pbase_location']) && $p_order_detail['pbase_location'] == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                            </div>
                                            <div class="profpkg-det-item">
                                                <div class="detitem-label"><?php esc_html_e('Account Members:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo (isset($p_order_detail['pbase_accmembs']) && $p_order_detail['pbase_accmembs'] == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                            </div>
                                            <div class="profpkg-det-item">
                                                <div class="detitem-label"><?php esc_html_e('Employer Team:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo (isset($p_order_detail['pbase_team']) && $p_order_detail['pbase_team'] == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                            </div>
                                            <div class="profpkg-det-item">
                                                <div class="detitem-label"><?php esc_html_e('Company Photos/Videos:', 'wp-jobsearch') ?></div> <div class="detitem-val"><?php echo (isset($p_order_detail['pbase_gphotos']) && $p_order_detail['pbase_gphotos'] == 'on' ? esc_html__('On', 'wp-jobsearch') : esc_html__('Off', 'wp-jobsearch')) ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="user-subsprofpkg-detail">
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="profpkg-hding"><span><?php esc_html_e('Plan Name', 'wp-jobsearch') ?></span></td>
                                        <td class="profpkg-titlemid"><span><?php echo ($attpordr_prod_name) ?></span></td>
                                        <td class="profpkg-btnsec"><div class="profpkg-btn-holdr"><a href="javascript:void(0);" class="modelprofpkg-btn-<?php echo ($profpkg_rand) ?>"><?php esc_html_e('View Detail', 'wp-jobsearch') ?></a></div></td>
                                    </tr>
                                    <tr>
                                        <td class="profpkg-hding"><span><?php esc_html_e('Price', 'wp-jobsearch') ?></span></td>
                                        <td class="profpkg-titlemid"><span><?php echo ($profpckg_order_price) ?></span></td>
                                        <td class="profpkg-btnsec">
                                            <?php
                                            if ($user_has_profpkg) {
                                                ?>
                                                <div class="profpkg-btn-holdr"><a href="javascript:void(0);" class="change-profpkg-planbtn"><?php esc_html_e('Change Plan', 'wp-jobsearch') ?></a></div>
                                                <?php
                                            } else {
                                                echo '&nbsp;';
                                            }
                                    ...
                                    <tr>
                                        <td class="profpkg-hding"><span><?php esc_html_e('Expiry', 'wp-jobsearch') ?></span></td>
                                        <?php
                                        $unlimited_pkg = get_post_meta($usercurnt_attpordr_id, 'unlimited_pkg', true);
                                        if ($unlimited_pkg == 'yes') {
                                            ?>
                                            <td class="profpkg-titlemid"><span style="color: #00aa00;"><?php echo ($usercurnt_attpordr_date) ?></span> - <span style="color: #ff0000;"><?php esc_html_e('Never Expire', 'wp-jobsearch') ?></span></td>
                                            <?php
                                        } else {
                                            ?>
                                            <td class="profpkg-titlemid"><span style="color: #00aa00;"><?php echo ($usercurnt_attpordr_date) ?></span> - <span style="color: #ff0000;"><?php echo date_i18n(get_option('date_format'), $usercurnt_attpordr_exp) ?></span></td>
                                            <?php
                                        }
                                        if (!$profpkg_is_subscribe) {
                                            ?>
                                            <td class="profpkg-btnsec"><div class="profpkg-btn-holdr renewal-btn"><a href="javascript:void(0);" class="jobsearch-subsemp-profile-pkg" data-id="<?php echo($usercurnt_attpordr_pkgid) ?>"><?php esc_html_e('Renewal', 'wp-jobsearch') ?> <span class="pkg-loding-msg" style="display:none;"></span></a></div></td>
                                            <?php
                                        } else {
                                            ?>
                    ...
                    if ($all_othrprof_pkghtml != '') {
                        ?>
                        <div id="jobsearch-profilpkgs-hcon" class="all-profilpkgs-hcon <?php echo ($user_has_profpkg ? 'with-has-profpkg' : '') ?>" <?php echo ($user_has_profpkg ? 'style="display: none;"' : '') ?>>
                    ...
                    if ($job_aply_type == 'with_email') {
                        ...
                        if (!empty($job_applicants_list)) {
                            ...
                            <div class="jobsearch-job-title">
                                <h2 class="jobsearch-pst-title"><a href="<?php echo ($apllicans_link) ?>"><?php echo get_the_title($_job_id) ?></a></h2>
                            </div>
                            <?php
                                    ...
                                    foreach ($job_applicants_list as $apply_data) {
                                        ...
                                        if (email_exists($user_email)) {
                                            ...
                                            if (jobsearch_user_is_candidate($_user_id)) {
                                                ...
                                                $jobsearch_candi_approved = get_post_meta($candidate_id, 'jobsearch_field_candidate_approved', true);
                                                $final_color = '';
                                                    ...
                                                    <div class="jobsearch-candidate-default-left">
                                                        ...
                                                        <ul>
                                                            ...
                                                            if ($user_email != '') {
                                                                ?>
                                                                <li>
                                                                    <i class="fa fa-envelope"></i> <a href="mailto:<?php echo ($user_email) ?>"><?php echo ($user_email) ?></a>
                                                                </li>
                                                                <?php
                                                            }
                        ...
                        if (!empty($job_applicants_list)) {
                            ...
                            ?>
                            <div class="jobsearch-job-title">
                                <h2 class="jobsearch-pst-title"><a href="<?php echo add_query_arg(array('tab' => 'manage-jobs', 'view' => 'applicants', 'job_id' => $_job_id), $page_url) ?>"><?php echo get_the_title($_job_id) ?></a></h2>
                            </div>
                            <?php
                            $list_title_html = ob_get_clean();
                            echo apply_filters('jobsearch_empdash_stats_jobslist_jobtitle_html', $list_title_html, $page_url, $_job_id);
                            ...
                            <div class="jobsearch-recent-applicants-nav">
                                <ul>
                                    ...
                                    ob_start();
                                    ?>
                                    <li><a href="<?php echo add_query_arg(array('tab' => 'manage-jobs', 'view' => 'applicants', 'job_id' => $_job_id), $page_url) ?>"><span><?php echo absint($job_applicants_count) ?></span> <small><?php esc_html_e('Total applicants', 'wp-jobsearch') ?></small></a></li>
                                    <?php
                                    $list_tapps_html = ob_get_clean();
                                    echo apply_filters('jobsearch_empdash_stats_jobslist_tapps', $list_tapps_html, $job_applicants_count, $_job_id);
