        ...
        if ($multiple_cv_files_allow == 'on') {
            ...
            if (isset($cv_files_count) && $cv_files_count >= $max_cvs_allow) {
                ...
                <div class="jobsearch-drpzon-con">
                    ...
                    <form action="<?php echo admin_url('admin-ajax.php') ?>" id="cvFilesDropzone" method="post" class="dropzone">
                        ...
                        <input type="hidden" name="action" value="jobsearch_dashboard_updating_candidate_cv_file">
                    </form>
                </div>
                <?php
            }
