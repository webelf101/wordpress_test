            ...
            <ul class="jobsearch-row jobsearch-employer-profile-form">
                ...
                if ($cand_dob_switch == 'on') {
                    if ($user_pkg_limits::cand_field_is_locked('profile_fields|date_of_birth')) {
                        ...
                        <li class="jobsearch-column-6">
                            <label><?php esc_html_e('Date of Birth:', 'wp-jobsearch') ?></label>
                            <input id="jobsearch-cand-dob-calnder" type="text" name="jobsearch_field_user_dob_whole" value="<?php echo ($user_dob_whole) ?>">
                            <script>
                ...
                <li class="jobsearch-column-12">
                    ...
                    ob_start();
                    ?>
                    <label class="cand-dash-desclabel"><?php esc_html_e('Description', 'wp-jobsearch') ?></label>
                    <?php
                    $title_html = ob_get_clean();
                ...
                <ul class="jobsearch-row jobsearch-employer-profile-form">
                    ...
                    if ($cand_alow_gplus_smm == 'on') {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <?php
                            if ($user_pkg_limits::cand_field_is_locked('social_links|google_plus')) {
                                echo ($user_pkg_limits::cand_gen_locked_html());
                            } else {
                                ?>
