<?php
/**
 * CV Packages Shortcode
 * @return html
 */
add_shortcode('careerfy_cv_packages', 'careerfy_cv_packages_shortcode');
function careerfy_cv_packages_shortcode($atts, $content = '')
{
...
add_shortcode('careerfy_cv_package_item', 'careerfy_cv_package_item_shortcode');
function careerfy_cv_package_item_shortcode($atts)
{
    global $view;
    extract(shortcode_atts(array(
        'att_pck' => '',
                        ...
                        <div class="careerfy-simple-priceplane-wrap">
                            ...
                            <div class="careerfy-simple-priceplane-basic">
                                ...
                                <?php if (is_user_logged_in()) { ?>
                                    <a href="javascript:void(0);" class="jobsearch-subscribe-cv-pkg"
                    ...
                    <div class="col-md-4">
                        <div class="careerfy-classic-priceplane <?php echo($featured == 'yes' ? 'active' : '') ?>">
                            ...
                            <div class="grab-classic-priceplane">
                                ...
                                <?php if (is_user_logged_in()) { ?>
                                    <a href="javascript:void(0);"
                                       class="careerfy-classic-priceplane-btn jobsearch-subscribe-cv-pkg"
