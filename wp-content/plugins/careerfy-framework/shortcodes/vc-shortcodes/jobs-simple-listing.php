                ...
                if ($job_list_style == 'style9') { ?>
                    <li class="col-md-12">
                        <div class="careerfy-refejobs-list-inner">
                            ...
                            ?>
                            <small><?php if ($get_job_location != '') { ?><i class="fa fa-map-marker"></i><?php echo esc_html($get_job_location); } ?></small>
                ...
                <?php } else if ($job_list_style == 'style8') { ?>
                    <li class="col-md-12">
                        <div class="careerfy-refejobs-list-inner">
                            ...
                            <small><?php if ($jobsearch_job_min_salary != '' && $jobsearch_job_max_salary != '') { ?><i class="fa fa-money"></i> <?php echo $jobsearch_job_min_salary . "K" ?>
                    ...
                    <li class="col-md-12">
                        <div class="careerfy-fifteen-recent-jobs-inner">
                            ...
                            <?php if ($job_post_date != '') { ?>
                                <time datetime="<?php echo date_i18n('Y-m-d ' . get_option('time_format'), $job_post_date) ?>">
                                    <i
