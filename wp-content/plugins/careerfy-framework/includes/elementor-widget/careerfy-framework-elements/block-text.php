...
class BlockTextWithVideo extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $title = $atts['title'];
        $bg_img = $atts['bg_img'] !='' ? $atts['bg_img']['url'] : '' ;
        $bg_color = $atts['bg_color'];
        $poster_img = $atts['poster_img'] != "" ? $atts['poster_img']['url'] : '';
    ...
    { ?>
        ...
        <div class="row">
            <div class="col-md-6 careerfy-parallex-box" style="background-image: url({{{bg_img}}}); background-color: {{{bg_color}}}">
                <div class="careerfy-parallex-box-wrap">
                    <h2>{{{title}}}</h2>
                    <# if(content !=''){ #>
                    <p>{{{content}}}</p>
