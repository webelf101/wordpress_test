...
function careerfy_responsive_logo($link_class = 'jobsearch-responsive-logo')
{
    ...
    $careerfy_logo = isset($careerfy_framework_options['geek-responsive-logo']['url']) && $careerfy_framework_options['geek-responsive-logo']['url'] != '' ? $careerfy_framework_options['geek-responsive-logo']['url'] : $logo_default_val;
...
if (!function_exists('careerfy_header_section')) {
    ...
    function careerfy_header_section()
    {
            ...
            <?php if ($top_strip == 'on') { ?>
                <div class="careerfy-header-twentyone-strip">
                    <div class="container">
                        <?php if ($top_phone != '') { ?>
                            <p>
                                <i class="fa fa-phone"></i><?php echo esc_html__('Call us on:', 'careerfy') ?> <a href="tel:<?php echo($top_phone) ?>"><?php echo($top_phone) ?></a>
                            </p>
                        <?php } ?>
                        <div class="top-strip-social-links">
                            <?php
            ...
            <div class="careerfy-header-sixteen-main">
                <div class="careerfy-blocksixteen-element">
                    ...
                    if (wp_is_mobile()) {
                        ...
                        careerfy_site_logo('careerfy-logo-sixteen');
                    } ?>
            ...
            <div class="careerfy-header-thirteen-main">
                <div class="careerfy-blockthirteen-element">
                    ...
                    if (wp_is_mobile()) {
                        ...
                        careerfy_site_logo('careerfy-logo-thirteen');
                    } ?>
                    <nav class="jobsearch-navigation">
                        <div class="collapse " id="jobsearch-navbar-collapse-1">
                            <ul class="navbar-nav">
                    ...
                    <div class="container">
                        <div class="careerfy-block-element">
                            ...
                            if (wp_is_mobile()) {
                                ...
                                careerfy_site_logo('careerfy-logo-twelve');
                            } ?>
                        </div>
                        <div class="careerfy-block-element">
                            <?php
        ...
        <?php } else if ($header_style == "style11") {
            ...
            <div class="careerfy-header-eleven-main">
                ...
                if (wp_is_mobile()) {
                    ...
                    careerfy_site_logo('careerfy-logo');
                } ?>
                <nav class="jobsearch-navigation">
                    <div class="collapse" id="jobsearch-navbar-collapse-1">
                        <ul class="navbar-nav">
        ...
        <?php } else if ($header_style == 'style2') { ?>
            <div class="header-tabel">
                <div class="header-row">
                    <div class="careerfy-logo-con"> <?php
                        if (wp_is_mobile()) {
                            careerfy_responsive_logo();
                        } else {
                            careerfy_site_logo();
                ...
                <div class="row">
                    <div class="header-tabel">
                        <div class="header-row">
                            ...
                            ob_start();
                            if (wp_is_mobile()) { ?>
                                <div class="careerfy-logo-con"><?php careerfy_responsive_logo() ?></div>
                            <?php } else { ?>
                                <div class="careerfy-logo-con">
