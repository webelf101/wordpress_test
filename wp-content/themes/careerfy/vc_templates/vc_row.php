...
if (isset($careerfy_overlay) && $careerfy_overlay == 'yes') {
    $wrapper_style_atts[] = 'position: relative; ';
}

//if (!empty($parallax_image)) {
//    $parallax_image_src = $parallax_image;
//    $wrapper_style_atts[] = 'background-image: url(\'' . esc_attr($parallax_image_src) . '\'); background-attachment: fixed;';
//}
if (!empty($parallax_image)) {
    if ($has_video_bg) {
        $parallax_image_src = $parallax_image;
...
if (is_page() && isset($careerfy_container) && $careerfy_container == 'box') {
    $page_view = get_post_meta(get_the_ID(), 'careerfy_field_page_view', true);
    if ($page_view == 'wide') {
...
echo careerfy_custom_str($output);
