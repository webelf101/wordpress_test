...
if (class_exists('JobSearch_plugin')) {
    ...
    ?>
    <div class="careerfy-speakers-grid" id="jobsearch-candidate-<?php echo absint($candidate_short_counter) ?>">
            ...
            if ($candidate_loop_obj->have_posts()) {
                ...
                while ($candidate_loop_obj->have_posts()) : $candidate_loop_obj->the_post();
                    ...
                    <li class="<?php echo esc_html($columns_class); ?>">
                        <div class="careerfy-speakers-grid-wrap">
                            <figure>
                                ...
                                <?php } ?>
                                <?php echo $jobsearch_candidate_salary_list ?>
                            </figure>
                            <div class="careerfy-speakers-grid-text">
