                    ...
                    <div class="careerfy-joblisting-plain-wrap">
                        ...
                        <div class="careerfy-joblisting-plain-text">
                            <div class="careerfy-joblisting-plain-left">
                                <h2 class="<?php echo($quick_apply_job_btn) ?>" data-job-id="<?php echo esc_html($job_id); ?>">
                                    <a href="<?php echo $quick_apply_job == 'on' ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>" title="<?php echo get_the_title($job_id); ?>" >
                                ...
                                <ul>
                                    ...
                                    if ($job_post_date != '' && $job_views_publish_date == 'on') {
                                        ?>
                                        <li><i class="jobsearch-icon jobsearch-calendar"></i><?php printf(esc_html__('Published %s', 'careerfy'), jobsearch_time_elapsed_string($job_post_date)); ?></li>
                                        <?php
                                    }
                                    do_action('jobsearch_job_listing_deadline', $atts, $job_id);
                                    if ($job_salary != '') {
                                        ?>
                                        <li><i class="careerfy-icon careerfy-money"></i> <?php echo ($job_salary) ?></li>
                                        <?php
                                    }
                                    ?>
                                </ul>
                            ...
                            <div class="careerfy-joblisting-plain-right">
                                ...
                                if ($job_city_title != '' && $all_location_allow == 'on') {
                                    ?>
                                    <small><i class="careerfy-icon careerfy-map-pin"></i> <?php echo ($job_city_title) ?></small>
                                    <?php
                                }
...
?>
<div class="careerfy-job-listing careerfy-joblisting-plain" id="jobsearch-job-<?php echo absint($job_short_counter) ?>">
...
<?php
echo $jobsearch_shortcode_jobs_frontend->jobsearch_quick_job_popup_callback();