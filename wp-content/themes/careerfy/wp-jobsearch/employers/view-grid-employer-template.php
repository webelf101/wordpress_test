        ...
        <ul class="row">
            ...
            if ($employer_loop_obj->have_posts()) {
                ...
                while ($employer_loop_obj->have_posts()) : $employer_loop_obj->the_post();
                    ...
                    ?>
                    <li class="<?php echo esc_html($columns_class); ?> <?php echo($no_follow_class) ?> ">
                        ...
                        <div class="careerfy-employer-grid-wrap">
                            ...
                            <figure>
                                <?php if ($post_thumbnail_src != '') { ?>
                                    <a href="<?php the_permalink(); ?>" class="careerfy-employer-grid-image"><img
                        ...
                        <a href="<?php echo esc_url(get_permalink($employer_id)); ?>"
                           class="careerfy-employer-grid-btn"><?php echo($jobsearch_employer_job_count_str) ?></a>
